...
export default function aboutMe() {
  return (
      <section className='h-screen w-full bg-transparent'>
        <div className='w-full h-[1.5rem] '> {/*ye header ka container hai */}
    ...
    <div className='flex flex-col md:flex-row items-center justify-center  md:gap-[5rem] bg-transparent mt-12 md:mt-20'>  {/*ye photo aur description ka container hai */}
        <div className="bg-transparent md:bg-transparent text-white  h-[18rem] w-[18rem] md:w-[32rem] md:h-[32rem]  flex items-center justify-center">  {/*ye photo ka container hai*/}
       <img className="h-full w-[23rem] rounded" src={MysecondPhoto} alt="Nikhil's Avatar"/>
       </div>
        <div className=" h-[25rem] w-[25rem] md:w-[30rem] md:h-[22rem]  bg-transpatent rounded-[5rem]  shadow-lg shadow-indigo-600/100 flex flex-col items-center justify-center"> {/*ye description ka container hai*/}
